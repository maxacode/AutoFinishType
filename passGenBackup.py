...
global howManyNumbers, howManyLowerletters, howManyUpperletters, howManySpecial
...
def passSpecifics():
    ...
    return howManyNumbers, howManyLowerletters, howManyUpperletters, howManySpecial
